...
var map_parks = L.map('map_parks', {
  zoomControl:true, maxZoom:19, minZoom:1
})
map_parks.zoomControl.setPosition('topright');
//var hash = new L.Hash(map_parks);
map_parks.attributionControl.addAttribution('<a href="https://github.com/tomchadwin/qgis2web" target="_blank">qgis2web</a>');
var feature_group = new L.featureGroup([]);
var bounds_group = new L.featureGroup([]);
var raster_group = new L.LayerGroup([]);
var basemap0 = L.tileLayer('http://{s}.basemaps.cartocdn.com/light_nolabels/{z}/{x}/{y}.png', {
attribution: '&copy; <a href="http://www.openstreetmap_parks.org/copyright">OpenStreetmap_parks</a> &copy; <a href="http://cartodb.com/attributions">CartoDB</a>',
subdomains: 'abcd',
maxZoom: 19
});
basemap0.addTo(map_parks);
function setBounds() {
  if (bounds_group.getLayers().length) {
      map_parks.fitBounds(bounds_group.getBounds());
  }
}
function geoJson2heat(geojson, weight) {
return geojson.features.map_parks(function(feature) {
  return [
...
map_parks.createPane('pane_Commareas0');
map_parks.getPane('pane_Commareas0').style.zIndex = 400;
...
map_parks.createPane('pane_2016watermains1');
map_parks.getPane('pane_2016watermains1').style.zIndex = 602;
...
map_parks.createPane('pane_2016water2');
map_parks.getPane('pane_2016water2').style.zIndex = 603;
...
map_parks.createPane('pane_ParkResults3');
map_parks.getPane('pane_ParkResults3').style.zIndex = 604;
...
map_parks.createPane('pane_SchoolTestResults4');
map_parks.getPane('pane_SchoolTestResults4').style.zIndex = 605;
...
/*map_parks.createPane('pane_Top10Schools5');
map_parks.getPane('pane_Top10Schools5').style.zIndex = 620;
...
raster_group.addTo(map_parks);
feature_group.addTo(map_parks);
var title = new L.Control({position: 'topleft'});
title.onAdd = function (map_parks) {
  this._div = L.DomUtil.create('div', 'info');
  this.update();
  return this._div;
};
title.update = function () {
  this._div.innerHTML = '<h2>City Parks, by Percentage of Fixtures Testing Above EPA Action Level</h2>';
};

title.addTo(map_parks);
...
setBounds();
map_parks.createPane('labels');
map_parks.getPane('labels').style.zIndex = 650;
map_parks.getPane('labels').style.pointerEvents = 'none';
map_parks.getPane('pane_Commareas0').style.pointerEvents = 'none';
var positronLabels = L.tileLayer('http://{s}.basemaps.cartocdn.com/light_only_labels/{z}/{x}/{y}.png', {
attribution: '©OpenStreetmap_parks, ©CartoDB',
pane: 'labels'
}).addTo(map_parks);
